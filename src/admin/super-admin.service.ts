...
export class SuperAdminService {
  ...
  async updateAdminRolePermissions(
    ...
    if (
      ...
      throw new BadRequestException(
        `The following permissions are reserved for SUPER_ADMIN: ${forbiddenPermissions.join(', ')}`,
      );
    }
  ...
  private async getManagedAdmin(
    ...
    if (
      ...
      throw new BadRequestException(
        'SUPER_ADMIN accounts cannot be modified through ADMIN management endpoints',
      );
    }
